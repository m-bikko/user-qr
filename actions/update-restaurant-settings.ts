...
export async function updateRestaurantSettingsAction(restaurantId: string, data: { telegram_chat_id?: string, primary_color?: string, background_color?: string, commission_percentage?: number }) {
